    ...
    <div class="container">
        ...
        <?php if(is_array($softs)): $i = 0; $__LIST__ = $softs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$it): $mod = ($i % 2 );++$i;?><div class="row">
                ...
                <div class="col-md-8 col-lg-9">
                    <ul class="list-group">
                        <li class="list-group-item list-group-item-success"><h3><?php echo L('soft_name');?>:<?php echo ($it["name"]); ?></h3></li>
                        ...
                        <li class="list-group-item">软件类别:<?php echo ($it["tname"]); ?></li>
                    </ul>
                </div>
            </div><?php endforeach; endif; else: echo "" ;endif; ?>
    <!--<ul class="thumbnails">
    <?php if(is_array($softs)): $i = 0; $__LIST__ = $softs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$it): $mod = ($i % 2 );++$i;?><li class="thumbnail">
                <div class="col-md-4 col-lg-3">
                    <a href="#" class="thumbnail">
                        <img src="/TpSoft/Public/<?php echo ($it['icon']); ?>">
                    </a>
