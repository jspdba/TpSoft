    ...
    <div class="container">
        <!--<div class="collapse navbar-collapse">-->
            <ul class="nav navbar-nav col-lg-9">
                ...
                <li ><a href="<?php echo U('Home/Soft/index');?>">更多软件</a></li>
                    ...
                    <div class="navbar-form">
                        <form id="search" action="<?php echo U('Home/Soft/search');?>" method="post">
                            <div class="input-group">
                                <input name="name" class="form-control" type="text" placeholder="软件搜索">
            ...
            <ul class="nav navbar-nav navbar-right">
                <!--<li class="navbar-form">
                    <form action="<?php echo U('Home/Soft/search');?>" method="post">
                        <div class="input-group">
                            <input name="name" class="form-control" type="text" placeholder="软件搜索">
                            <span class="input-group-btn">
...
<div id="wrap">
    ...
    <div class="jumbotron">
        <h1>秋业原专卖店</h1>
        <p class="lead">软件专卖</p>
        <p class="lead">联系信箱    jspdba@163.com</p>
        <a class="btn btn-large btn-success" href="#">联系我们</a>
    </div>

        
    <div id="content"><!--最新软件显示4个吧-->
        <!--<ul class="media-list">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <a href="">最新软件</a>
                <a href="<?php echo U('Home/Soft/Index');?>" class="pull-right">More</a>
            </div>
             <div class="panel-body">
                 <div class="row">
                     <?php if(is_array($newest)): $i = 0; $__LIST__ = $newest;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$it): $mod = ($i % 2 );++$i;?><div class="col-md-4">
                             <div class="thumbnail">
