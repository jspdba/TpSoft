    ...
    <div class="container">
        ...
        <?php if(is_array($softs)): $i = 0; $__LIST__ = $softs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$it): $mod = ($i % 2 );++$i;?><div class="row">
                ...
                <div class="col-md-8 col-lg-9">
                    <ul class="list-group">
                        <li class="list-group-item list-group-item-success"><h3>软件名称:<?php echo ($it["name"]); ?></h3></li>
                        <li class="list-group-item">软件语言：<?php echo ($it["lang"]); ?></li>
                        <li class="list-group-item">软件环境：<?php echo ($it["env"]); ?></li>
                        <li class="list-group-item">软件价格：<?php echo ($it["price"]); ?></li>
                    </ul>
                </div>
