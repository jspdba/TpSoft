                ...
                <div class="panel-body">
                    <table class="table table-bordered table-condensed">
                        ...
                        <?php if(is_array($topics)): $i = 0; $__LIST__ = $topics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$it): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><a href="<?php echo U('Xssxyby/Topic/delete?id='.$it['id']);?>"><i class="glyphicon glyphicon-check"></i> 删除</a></td>
                                <td><a href="<?php echo U('Xssxyby/Topic/input?id='.$it['id']);?>"><i class="glyphicon glyphicon-check"></i> 修改</a></td>
